...
// -----------------------------------------------------------------------------
// 2. Sécurité continue : Rapatriement Overworld et destruction de portails
// -----------------------------------------------------------------------------
ServerEvents.tick(function(event) {
    // Vérification rapide toutes les 5 ticks (4 fois par seconde)
    if (event.server.getTickCount() % 5 !== 0) return
