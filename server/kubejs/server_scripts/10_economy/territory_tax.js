...
var TAX_CONFIG = (typeof TW_CONFIG !== 'undefined' && TW_CONFIG.taxes) ? {
    PLAYTIME_CYCLE_MINUTES: TW_CONFIG.taxes.playtime_cycle_minutes || 60,
    GRACE_PLAYTIME_MINUTES: TW_CONFIG.taxes.grace_playtime_minutes || 120,
    UNCLAIM_PERCENT_ON_DEBT: TW_CONFIG.taxes.unclaim_percent_on_debt || 0.15,
    MIN_CHUNKS_EXEMPT: TW_CONFIG.taxes.min_chunks_exempt !== undefined ? TW_CONFIG.taxes.min_chunks_exempt : 4
} : {
    PLAYTIME_CYCLE_MINUTES: 60,
    GRACE_PLAYTIME_MINUTES: 120,
    UNCLAIM_PERCENT_ON_DEBT: 0.15,
    MIN_CHUNKS_EXEMPT: 4
}
...
/**
 * Tick chaque minute (1200 ticks de jeu) via Master Scheduler : accumulation de temps d'activité
 */
if (typeof TW_Scheduler !== 'undefined' && TW_Scheduler.register) {
    TW_Scheduler.register('territory_taxes', 1200, function(server) {
...
function showNationTaxOverview(player) {
    ...
    try {
        ...
        var balance = (typeof getFormattedNationBalance === 'function') 
